        ...
        <div className="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-700">
            ...
            <div className="space-y-1 text-left sm:text-center">
              <dl className="space-y-10">
                <div>
                  ...
                  <dd className="text-xs leading-5 font-medium text-black dark:text-gray-400">
                    <time dateTime={date}>
              ...
              <div className="flex items-center justify-start gap-2 pt-2 sm:justify-center">
          ...
          <div className="pb-8">
            ...
            {siteMetadata.comments && (
              <div className="pt-6 pb-6 text-center text-gray-700 dark:text-gray-200" id="comment">
                <Comments slug={slug} />
              </div>
            )}
          </div>

...
const Card = ({ title, description, imgSrc, href, imageContain = false }) => (
  <div className="md max-w-[544px] p-0 md:w-1/2 xl:w-1/3">
    <div
      className={`${
        imgSrc && 'h-full'
      } overflow-hidden rounded-md border-2 border-gray-200/60 transition duration-200 ease-out hover:-translate-y-1 hover:border-[#047857]/60 hover:shadow-lg dark:border-gray-700/60 dark:hover:border-[#34D399]/60`}
    >
      {imgSrc &&
        (href ? (
      ...
      <div className="p-6">
        ...
        {href && (
          <Link
            href={href}
            className="text-base leading-6 font-medium text-[#047857] hover:text-[#065f46] dark:text-[#34D399] dark:hover:text-[#6ee7b7]"

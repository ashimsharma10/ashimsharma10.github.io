...
"Spin" is the most misleading word in that table, so it gets its own animation: the myth, what measurement actually shows, and the genuinely strange part nobody's analogy survives.

...
draft: false
summary: 'A deep guide for ML infrastructure engineers covering tensors, memory layout, autograd, nn.Module, training loops, optimizers, DDP, FSDP, distributed checkpointing, and debugging at scale.'
---
...
**A tensor computation library** (like NumPy but with GPU support)
— Tensors, math ops, reshaping, indexing, broadcasting.

**An automatic differentiation engine** (autograd)
— Records operations, builds a computation graph, computes gradients via backpropagation.

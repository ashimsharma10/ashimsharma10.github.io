...
export const SEARCH_TOOL = {
  ...
  description:
    ...
    'guardrails, LLM quality measurement and token and cost optimization, self-improving agents such as ' +

...
export const SEARCH_TOOL = {
  ...
  description:
    ...
    'pandas, Claude Code, graph engineering for AI agents, quantum and particle physics, and more). Use this for any factual question about you, AND whenever a ' +

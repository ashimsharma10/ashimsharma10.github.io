...
export const SEARCH_TOOL = {
  ...
  description:
    ...
    'data science interview prep, quantum and particle physics, and more). Use this for any factual question about you, AND whenever a ' +

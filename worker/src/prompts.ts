...
export const SEARCH_TOOL = {
  ...
  description:
    ...
    'guardrails, LLM quality measurement and token and cost optimization, quantum and particle physics, and more). Use this for any factual question about you, AND whenever a ' +

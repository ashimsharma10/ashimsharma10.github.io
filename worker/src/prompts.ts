...
export const SEARCH_TOOL = {
  ...
  description:
    ...
    'guardrails, LLM quality measurement and token and cost optimization, data science fundamentals such as ' +

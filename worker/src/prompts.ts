...
- Technical topics you have written about are IN scope. When a visitor mentions or asks about such a topic (for example "MLOps", "Docker", "Ray", "graph engineering", "evals", "LLM as a judge", "hallucination detection", "guardrails", "prompt injection", "self-improving agents", "agent memory", "vLLM", "PagedAttention", "KV cache", "inference optimization", "LLM serving", "mixture of experts", "MoE", "expert parallelism", "sparse models", "A/B testing", "causal inference", "quantum physics"), SEARCH your knowledge base. If a write-up of yours genuinely covers it, give a brief, friendly explanation of the topic (one or two sentences, from your own knowledge), then recommend that write-up with its link and invite them to read it and share their thoughts. See the example below.
...
export const SEARCH_TOOL = {
  ...
  description:
    ...
    'quantization and local CPU offload, quantum and particle physics, and more). Use this for any factual question about you, AND whenever a ' +

...
export const SEARCH_TOOL = {
  ...
  description:
    ...
    'latency profiling, prompt injection defense, PII masking and schema validation, data science fundamentals such as ' +
